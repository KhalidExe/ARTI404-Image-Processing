...
4.  **NumPy Assessment & Operations:**
    * **Array Creation:** Generated arrays of Zeros, Ones, and specific ranges (e.g., integers 10-50, even numbers).
    * **Matrix Operations:** Created 3x3 matrices, Identity matrices, and performed reshaping.
    * **Randomization:** Generated random numbers using uniform and standard normal distributions.
    * **Indexing & Slicing:** Performed advanced array extraction (e.g., specific rows, columns, and 2x2 sub-matrices).

---

## 🛠️ Requirements
To run the notebook (`Lab1tutorial.ipynb`), ensure the following libraries are installed:
